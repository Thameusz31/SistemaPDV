...
def create_tables():
    ...
    # Tabela de Vendas (ALTERADA para incluir juros_aplicados)
    # ATENÇÃO: Se você já tem o arquivo 'loja_streetwear.db' e dados de vendas,
    # RECOMENDO FORTEMENTE APAGÁ-LO antes de rodar o main_app.py para que a nova coluna seja criada.
    # Caso contrário, você precisaria executar um comando ALTER TABLE:
    # ALTER TABLE vendas ADD COLUMN juros_aplicados REAL DEFAULT 0.0;
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS vendas (
            ...
            juros_aplicados REAL NOT NULL DEFAULT 0.0, -- NOVA COLUNA
