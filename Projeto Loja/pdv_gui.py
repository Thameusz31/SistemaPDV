...
class PDVGUI(ttk.Frame):
    ...
    def __init__(self, master):
        ...
        self.juros_aplicados = 0.0 # Variável para juros
        ...
        self.desconto_entry_var = tk.StringVar(value="0.00") # Movido e inicializado corretamente
        self.juros_tipo_var = tk.StringVar(value="Percentual")
        self.juros_entry_var = tk.StringVar(value="0.00") # Movido e inicializado corretamente
        ...
        # Corrigido o nome do LabelFrame e do método abaixo
        ...
        self.create_desconto_juros_pontos_widgets(self.frame_desconto_juros_pontos) # CORRIGIDO AQUI
    ...
    def create_desconto_juros_pontos_widgets(self, parent_frame):
        ...
        self.desconto_entry = ttk.Entry(parent_frame, textvariable=self.desconto_entry_var, width=15) # Usando StringVar para o Entry
        self.desconto_entry.grid(row=1, column=1, sticky="ew", padx=5, pady=2)
        self.desconto_entry_var.set("0.00") # Inicializa o StringVar
        ...
        ttk.Label(parent_frame, text="Tipo de Juros:").grid(row=3, column=0, sticky="w", padx=5, pady=2) # Linha 3
        self.juros_tipo_var = tk.StringVar(value="Percentual")
        ...
        ttk.Label(parent_frame, text="Valor dos Juros:").grid(row=4, column=0, sticky="w", padx=5, pady=2) # Linha 4
        self.juros_entry = ttk.Entry(parent_frame, textvariable=self.juros_entry_var, width=15) # Usando StringVar para o Entry
        self.juros_entry.grid(row=4, column=1, sticky="ew", padx=5, pady=2)
        self.juros_entry_var.set("0.00") # Inicializa o StringVar
        self.juros_entry.bind("<KeyRelease>", lambda event=None: self.update_total_with_discount())

        self.juros_aplicados_label = ttk.Label(parent_frame, text="Juros Aplicados: R$ 0.00", font=("Arial", 10)) # Linha 4
        ...
        ttk.Label(parent_frame, text="Pontos Disponíveis:").grid(row=6, column=0, sticky="w", padx=5, pady=2) # Linha 6
        ...
        ttk.Label(parent_frame, text="Pontos para Utilizar:").grid(row=7, column=0, sticky="w", padx=5, pady=2) # Linha 7
        ...
        self.utilizar_valor_label = ttk.Label(parent_frame, text="Valor Utilizado: R$ 0.00", font=("Arial", 10)) # Linha 7
        ...
        self.apply_points_discount_button.grid(row=8, column=0, columnspan=4, pady=5) # Linha 8
        self.apply_points_discount_button.config(state=tk.DISABLED)
    ...
    def apply_points_discount(self):
        ...
        remaining_total_for_points_discount = self.total_venda - current_desconto_manual_valor 

        if valor_desconto_pontos > remaining_total_for_points_discount:
            ...
            valor_desconto_pontos = remaining_total_for_points_discount
